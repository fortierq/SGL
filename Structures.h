...
namespace sgl
{
	...
	\see Tree_List::pred */
	template<class Edge > class Tree_List<Edge>::iterator
	{
	...
	template<class Edge > class Tree_List<Edge>::iterator_all
	{
		const Tree_List<Edge>& T;
		int i;
	public:
	...
	template<class Edge > class Graph_List
	{
		int Vcnt;
		bool digraph;
		struct node
	...
	template<class Edge > class Graph_List<Edge>::iterator
	{
	...
	template<class Edge > class Graph_List<Edge>::iterator_all
	{
		const Graph_List<Edge>& G;
		int pos;
	...
	template<class Edge > class Graph_Matrix
	{
	...
	template<class Edge > class Graph_Matrix<Edge>::iterator
	{
	...
	/*! Ierates through all edges */
	template<class Edge > class Graph_Matrix<Edge>::iterator_all
	{
		const Graph_Matrix<Edge>& G;
		int i, j;
	public:
	...
	template<class Edge > class Bipartite_list : public Graph_List<Edge>
	{
	public:
